...
var bus = Bus.initialize(function(config) {
    config.queue = "serviceconnect.stomp.filters.sender";
    ...
    config.queueMappings = { // Destination to send messages to.  
        "Message1": ["serviceconnect.stomp.filters.consumer"],
        "Message2": ["serviceconnect.stomp.filters.consumer"],
        "Message3": ["serviceconnect.stomp.filters.consumer"]
    };
